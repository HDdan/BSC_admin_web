<template>
  <div class="mr-20 ml-20">
    ...
    >
      ...
      <el-table-column prop="Purpose" label="本次新经销商面谈主要目的" show-overflow-tooltip> </el-table-column>
      ...
      <el-table-column prop="Controller" label="被访谈者是否为公司实际控制人" show-overflow-tooltip> </el-table-column>
